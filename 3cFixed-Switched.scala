...
val testingRowRDD = sc.makeRDD(rowRDD.take((rowRDD.count * 0.2).toInt))
print("------------log----------------\n# of training data: " + trainingRowRDD.count + "\n------------log----------------\n")
val trainingRowRDD = rowRDD.subtract(testingRowRDD)
...
val testingData = spark.createDataFrame(testingRowRDD, schema).withColumn("label", 'label.cast("Double"))
